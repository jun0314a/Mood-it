...
public class TmdbClient {
    ...
    private final String TMDB_SEARCH_URL = "https://api.themoviedb.org/3/search/multi";

    public TmdbContentDetail searchContentByTitle(String title) {
        RestTemplate restTemplate = new RestTemplate();

        UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(TMDB_SEARCH_URL)
        ...
        if (results != null && !results.isEmpty()) {
            Map<String, Object> content = results.get(0);
